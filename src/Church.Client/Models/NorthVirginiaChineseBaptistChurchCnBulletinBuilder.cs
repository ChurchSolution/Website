// --------------------------------------------------------------------------------------------------------------------
// <copyright file="NorthVirginiaChineseBaptistChurchCnBulletinBuilder.cs" company="Church">
...
namespace Church.Models
{
    ...
    public class NorthVirginiaChineseBaptistChurchCnBulletinBuilder : BulletinTextBuilder
    {
        ...
        public NorthVirginiaChineseBaptistChurchCnBulletinBuilder() : base(CultureInfo.CreateSpecificCulture("zh-CN")) { }
        ...
        protected IEnumerable<string> ProcessWeeklyReading(Bulletin bulletin, IEnumerable<string> lines)
        {
            return Enumerable.Empty<string>();
        }
        ...
        protected IEnumerable<string> ProcessChurchOffice(Bulletin bulletin, IEnumerable<string> lines)
        {
            return Enumerable.Empty<string>();
        }
